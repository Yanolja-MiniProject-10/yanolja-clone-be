...
@AllArgsConstructor
@Getter
public class PaymentAccommodationResponse {
    ...
    private List<PaymentRoomOptionResponse> roomOptions;

    public static PaymentAccommodationResponse toAccommodationEntity(Accommodation accommodation) {
        return PaymentAccommodationResponse.builder()
